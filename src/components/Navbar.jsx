...
const Navbar = () => {
    return (
        <div className="d-flex justify-content-center align-items-center page-navbar">
            <nav className="navbar navbar-expand-lg bg-body-tertiary sticky-top" id="page_navbar">
                ...
                <div>
                    <a className="navbar-brand" href="./">
                        <img src="./img/dummy-logo.png" name="branding" alt="" />
                            <span>LMS</span>
                    </a>
                ...
                <div className="user-action">
                    ...
                    <a className="btn-default btn-opaque" href="signup">Sign up</a>
                </div>
